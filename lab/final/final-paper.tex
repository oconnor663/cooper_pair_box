...
\begin{abstract}
  ...
  studied by Vlad Manucharyan, and while computer models of the energy
  spectrum for these circuits exist, faster models would be more
  helpful in interpreting the experimental data. We develop a computer
  model of the CPBL that is fast enough to run curve fitting on
